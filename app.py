...
if page == "🏠 Home":
    ...
    with st.expander("🎯 What we found", expanded=True):
    ...
    st.markdown("#### Image Denoising Demo choose a dataset and noise level for real time implementation")
    try:
        # Load data and model
    ...
    with cols[1]:
        st.markdown("""
       #### Jarin Tasnim Rahman
        **Email:** jarintasnim2@iut-dhaka.edu  
